...
// Your existing logo
const LOGO_URL =
  'https://customer-assets.emergentagent.com/job_240d2bbd-3c0b-4480-8285-5c1a7a1b83e1/artifacts/6pe1cay2_1_a6b69119.jpg';
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <a href="/" className="flex items-center gap-3 group">
          <div
            className="relative w-11 h-11 rounded-full overflow-hidden ring-2 ring-offset-2 ring-offset-transparent"
            style={{ boxShadow: `0 0 0 2px ${COLORS.saffron}99` }}
          >
            <img
              src={LOGO_URL}
        ...
        <nav className="hidden lg:flex items-center gap-8">
          {NAV_LINKS.map((l) => (
            <a
              ...
              style={{ color: `${COLORS.mist}CC` }}
              onMouseEnter={(e) => (e.currentTarget.style.color = COLORS.saffron)}
              onMouseLeave={(e) =>
                (e.currentTarget.style.color = `${COLORS.mist}CC`)
              }
            >
              {l.label}
              <span
